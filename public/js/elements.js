export const getIncomingCallDialog = (
  ...
  <div class="dialog_content">
    ...
    <div class="dialog_image_container">
      <img src="./utils/images/dialogAvatar.png" alt="Dialog Avatar" />
    </div>
    <div class="dialog_button_container">
      <button class="dialog_accept_call_button">
        <img class="dialog_button_image" src="./utils/images/acceptCall.png" alt="Accept Button Image" />
      </button>
      <button class="dialog_reject_call_button">
        <img class="dialog_button_image" src="./utils/images/rejectCall.png" alt="Reject Button Image" />
      </button>
    </div>
  </div>
  `;
